        ...
        IntStream.range(0, EchoBenchmarkMain.threads).parallel().forEach { i: Int ->
            ...
            ChronicleQueue.singleBuilder(base + i)
                ...
                .build().use { q ->
                    ...
                    val writer = appender.methodWriter(CommandQueueHandler.PingBinaryStatusHandler::class.java)
        ...
        IntStream.range(0, EchoBenchmarkMain.threads).parallel().forEach { i: Int ->
            ChronicleQueue.singleBuilder(base + i)
                ...
                .build().use { q ->
                    ...
                    val pingReader = tailer.methodReader(Echo.ReadPingBinary())
